"""
Example: Running a Hydrological Model with the Xinanjiang Runoff Module
========================================================================

This script demonstrates how to load and run a hydrological model that uses the
new XinanjiangRunoffModule, defined entirely in a YAML file.
"""
import sys
import os
...
def main():
    ...
    """
    config_file = "examples/config_xaj.yaml"
